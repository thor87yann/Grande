...
public class Tela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel42.setBackground(new java.awt.Color(105, 140, 108));
        ...
        BotaoCadastrarDisciplinas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ClickBotaoCadastrarDisciplinasMouseClicked(evt);
            }
        });
 ...
 /*DefaultTableModel dtmExcluirAlunosDoSistema = (DefaultTableModel) TabelaRemoverAlunos.getModel();
    ...
    private void ClickBotaoCadastrarAluno(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ClickBotaoCadastrarAluno
        ...
        LimparCaixasDeTextos();
         CoresBotoesMenu();
        jLabel4.setBackground(new Color(104,144,114));
    ...
    private void ClickNoBotaoCadastrarTurmas(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ClickNoBotaoCadastrarTurmas
        LimparMiniTela();
        CoresBotoesMenu();
        jLabel3.setBackground(new Color(104,144,114));
    ...
    private void ClickBotaoCadastrarDocentes(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ClickBotaoCadastrarDocentes
        ...
        LimparCaixasDeTextos();
         CoresBotoesMenu();
        jLabel5.setBackground(new Color(104,144,114));
    ...
    private void ClickBotaoCadastrarDisciplinasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ClickBotaoCadastrarDisciplinasMouseClicked
        LimparMiniTela();
        LimparCaixasDeTextos();
         CoresBotoesMenu();
        jLabel6.setBackground(new Color(104,144,114));
        CadastrarDisciplina.setVisible(true);

    }//GEN-LAST:event_ClickBotaoCadastrarDisciplinasMouseClicked
